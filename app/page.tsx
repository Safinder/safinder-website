          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="https://apps.apple.com/es/app/safinder/id6749938283?l=en-GB" target="_blank" rel="noopener noreferrer">
                  <Button
                    size="lg"
                ...
                <Link
                  href="https://play.google.com/store/apps/details?id=com.admin.Safinder&pcampaignid=web_share"
                  target="_blank"
                ...
                >
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 border-pink-400 text-pink-600 hover:bg-pink-50 px-8 py-4 text-lg rounded-full bg-transparent w-full"
                  >
